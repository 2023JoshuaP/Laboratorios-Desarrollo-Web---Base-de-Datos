...
function Home() {
  ...
  const idImpares = () => {
    axios.get('http://localhost:3001/mostrarIDimpares', { withCredentials: true })
      .then(res => {
        setIdImpar(res.data);
      })
      .catch(err => {
    ...
    <div className='container mt-4'>
      {
        ...
        <div>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <div>
              <h3>Administrador Floreria autorizado</h3>
            </div>
            <div>
          ...
          <div style={{ display: 'flex', marginTop: '5px', position: 'relative' }}>
            <div style={{ width: '30%' }}>
              <input type="text" className='form-control' id="id" placeholder="id" style={{ marginBottom: '5px' }} /><br/>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                ...
                <button className='btn btn-primary' id="reporte" onClick={idImpares}>Reporte</button>
              </div>
              <br></br>
